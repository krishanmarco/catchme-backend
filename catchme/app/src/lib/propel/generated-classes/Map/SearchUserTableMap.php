...
/**
 * This class defines the structure of the 'search_user' table.
 *
 *
 *
...
class SearchUserTableMap extends TableMap {
     ...
     */
    const CLASS_NAME = '.Map.SearchUserTableMap';
     ...
     */
    const TABLE_NAME = 'search_user';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\SearchUser';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'SearchUser';
     ...
     */
    const COL_USER_ID = 'search_user.user_id';

    /**
     * the column name for the query field
     */
    const COL_QUERY = 'search_user.query';
    ...
    public static function populateObject($row, $offset = 0, $indexType = TableMap::TYPE_NUM) {
        ...
        if (null !== ($obj = SearchUserTableMap::getInstanceFromPool($key))) {
            ...
            $col = $offset + SearchUserTableMap::NUM_HYDRATE_COLUMNS;
        } else {
            $cls = SearchUserTableMap::OM_CLASS;
            /** @var SearchUser $obj */
            $obj = new $cls();
            $col = $obj->hydrate($row, $offset, false, $indexType);
            SearchUserTableMap::addInstanceToPool($obj, $key);
        }
    ...
    public static function populateObjects(DataFetcherInterface $dataFetcher) {
        ...
        while ($row = $dataFetcher->fetch()) {
            $key = SearchUserTableMap::getPrimaryKeyHashFromRow($row, 0, $dataFetcher->getIndexType());
            if (null !== ($obj = SearchUserTableMap::getInstanceFromPool($key))) {
                // We no longer rehydrate the object, since this can cause data loss.
                // See http://www.propelorm.org/ticket/509
    ...
    public static function doDelete($values, ConnectionInterface $con = null) {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \SearchUser) { // it's a model object
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null) {
        ...
        if ($criteria instanceof Criteria) {
            ...
            $criteria = $criteria->buildCriteria(); // build Criteria from SearchUser object
        }
...
//
SearchUserTableMap::buildTableMap();
