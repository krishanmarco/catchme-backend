...
abstract class User implements ActiveRecordInterface
{
     ...
     * @return ObjectCollection|ChildUserLocationFavorite[] List of ChildUserLocationFavorite objects
     */
    public function getFavoriteLocationsJoinLocationAddress(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildUserLocationFavoriteQuery::create(null, $criteria);
        $query->joinWith('LocationAddress', $joinBehavior);
