...
/**
 * Base class that represents a row from the 'user_location_favorite' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class UserLocationFavorite implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\UserLocationFavoriteTableMap';
    ...
    /**
     * Initializes internal state of Base\UserLocationFavorite object.
     */
    ...
    /**
     * Compares this with another <code>UserLocationFavorite</code> instance.  If
     * <code>obj</code> is an instance of <code>UserLocationFavorite</code>, delegates to
     * <code>equals(UserLocationFavorite)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|UserLocationFavorite The current object, for fluid interface
     */
    ...
    public function setUserId($v)
    {
        ...
        if ($this->user_id !== $v) {
            $this->user_id = $v;
            $this->modifiedColumns[UserLocationFavoriteTableMap::COL_USER_ID] = true;
        }
    ...
    public function setLocationId($v)
    {
        ...
        if ($this->location_id !== $v) {
            $this->location_id = $v;
            $this->modifiedColumns[UserLocationFavoriteTableMap::COL_LOCATION_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : UserLocationFavoriteTableMap::translateFieldName('UserId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->user_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : UserLocationFavoriteTableMap::translateFieldName('LocationId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = UserLocationFavoriteTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\UserLocationFavorite'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildUserLocationFavoriteQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see UserLocationFavorite::setDeleted()
     * @see UserLocationFavorite::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildUserLocationFavoriteQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                UserLocationFavoriteTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(UserLocationFavoriteTableMap::COL_USER_ID)) {
            $modifiedColumns[':p' . $index++]  = 'user_id';
        }
        if ($this->isColumnModified(UserLocationFavoriteTableMap::COL_LOCATION_ID)) {
            $modifiedColumns[':p' . $index++]  = 'location_id';
        }

        $sql = sprintf(
            'INSERT INTO user_location_favorite (%s) VALUES (%s)',
    ...
    {
        $pos = UserLocationFavoriteTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['UserLocationFavorite'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['UserLocationFavorite'][$this->hashCode()] = true;
        $keys = UserLocationFavoriteTableMap::getFieldNames($keyType);
        $result = array(
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\UserLocationFavorite
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UserLocationFavoriteTableMap::COL_USER_ID)) {
            $criteria->add(UserLocationFavoriteTableMap::COL_USER_ID, $this->user_id);
        }
        if ($this->isColumnModified(UserLocationFavoriteTableMap::COL_LOCATION_ID)) {
            $criteria->add(UserLocationFavoriteTableMap::COL_LOCATION_ID, $this->location_id);
        }
    ...
    {
        $criteria = ChildUserLocationFavoriteQuery::create();
        $criteria->add(UserLocationFavoriteTableMap::COL_USER_ID, $this->user_id);
        $criteria->add(UserLocationFavoriteTableMap::COL_LOCATION_ID, $this->location_id);
    ...
    public function hashCode()
    {
        ...
        //relation user_location_favorite_fk_29554a to table user
    ...
    {
        return (null === $this->getUserId()) && (null === $this->getLocationId());
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \UserLocationFavorite (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \UserLocationFavorite Clone of current object.
     * @throws PropelException
     */
    ...
    public function getLocation(ConnectionInterface $con = null)
    {
        if ($this->aLocation === null && ($this->location_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aLocation->addSubscribedUsers($this);
             */
        }
    ...
    public function getUser(ConnectionInterface $con = null)
    {
        if ($this->aUser === null && ($this->user_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aUser->addFavoriteLocations($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(UserLocationFavoriteTableMap::DEFAULT_STRING_FORMAT);
    }
